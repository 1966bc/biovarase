...
class DBMS:
    ...
    def __init__(self, database, log):
        ...
        self.dict_tables = {}
        #: The date conversions sqlite3 is giving up, written down in dates.py
        #: and registered by building this. They belong to the module and not
        #: to this connection, which is why nothing else here touches them.
        self.dates = Dates()
        self.set_connection()
