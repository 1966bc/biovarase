...
class Main(tk.Toplevel):
    ...
    def _build_ui(self) -> None:
        ...
        self.lstWorkstations.column("description", width=100, minwidth=80, stretch=False, anchor=tk.W)
        self.lstWorkstations.column("serial", width=80, minwidth=60, stretch=False, anchor=tk.W)
        ...
        self.lstBatches.column("level", width=30, minwidth=25, stretch=False, anchor=tk.W)
        self.lstBatches.column("lot", width=70, minwidth=60, stretch=False, anchor=tk.W)
        self.lstBatches.column("expiration", width=80, minwidth=70, stretch=False, anchor=tk.W)
