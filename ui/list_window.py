...
Every master data list in the program is this one: units, samples, methods,
tests, actions, categories, suppliers. Each module says only which table,
which column is shown, and which dialog edits a row.

Inheritance where it belongs: a list of units *is a* list window. The engine,
by comparison, is not a database and has one.
"""
